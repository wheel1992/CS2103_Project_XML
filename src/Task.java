...
public class Task {
	...
	int _id;
	String _title;
	String _start_millisecond;
	String _end_millisecond;
	String _start_time;
	...
	public void setStartMillisecond(String startMs){
		this._start_millisecond = startMs;
	}
	
	
	public void setEndMillisecond(String endMs){
		this._end_millisecond = endMs;
	}
	...
	public String getStartMillisecond(){
